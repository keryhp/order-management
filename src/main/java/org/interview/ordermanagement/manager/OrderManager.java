...
public interface OrderManager {
     ...
     * @param price
     */
    void addOrder(int orderId, String symbol, Side side, int amount, int price) throws OrderManagementException;
     ...
     * @param orderId
     */
    void removeOrder(int orderId) throws OrderManagementException;
     ...
     * @param price
     */
    void modifyOrder(int orderId, int amount, int price) throws OrderManagementException;
     ...
     * @return
     */
    int calculatePrice(String symbol, Side side, int amount) throws OrderManagementException;
     ...
     * @param amount
     */
    void placeTrade(String symbol, Side side, int amount) throws OrderManagementException;
